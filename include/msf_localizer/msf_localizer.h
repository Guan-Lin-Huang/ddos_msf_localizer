...
private:
    ...
    ros::Subscriber _gps_novatel_heading_sub;
    ros::Subscriber _rtcm_status_topic_sub;
    ...
    void _gps_novatel_heading_callback(const novatel_gps_msgs::Inspva::ConstPtr input); 
    void _rtcm_stat_callback(const std_msgs::Int32::ConstPtr& input);
    ...
    std::string _gps_novatel_heading_topic_;  
    std::string _rtcm_status_topic_; 
    ...
    novatel_gps_msgs::Inspva _gps_novatel_data; 
